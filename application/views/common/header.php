...
<html>
  <head>
    <meta charset="UTF-8">
    <title><?= SHOP_APP_ADMIN; ?> | Dashboard</title>
  ...
  <body class="skin-blue sidebar-mini"><!DOCTYPE html>
<html>
  <head>
    <meta charset="UTF-8">
    ...
    <!-- DATA TABLES -->
    <link href="<?php echo base_url();?>assets/theme/plugins/datatables/dataTables.bootstrap.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url();?>assets/theme/plugins/noty/demo/animate.css" rel="stylesheet" type="text/css" />
...
<!--      <script src="<?php echo base_url();?>assets/theme/plugins/jQuery/jQuery-2.1.4.min.js"></script>
       DATA TABES SCRIPT 
    <script src="<?php echo base_url();?>assets/theme/plugins/datatables/jquery.dataTables.min.js" type="text/javascript"></script>
    <script src="<?php echo base_url();?>assets/theme/plugins/datatables/dataTables.bootstrap.min.js" type="text/javascript"></script>
