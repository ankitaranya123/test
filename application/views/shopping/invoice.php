<div class="content-wrapper" id="print">
    <?php $invoiceid = strtoupper(Shopping::generateRandomString()) ?>
...
<form action="<?= base_url('index.php/shopping/done')?>" method="post">
    <input type="hidden" name="sale_by" value="<?php echo $user_data['user_id'] ?>">
        <div class="row">
            ...
            <div class="col-xs-6">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            <th>Payed:
                            <td><input class="form-control" type="text" value="<?php if(set_value('payed') == false) { echo $total + ($total * ($tax / 100)) ; } else { echo set_value('payed');} ?>" name="payed" required=""></td>
                        </tr>
                    </table>
                </div>
            </div><!-- /.col -->
